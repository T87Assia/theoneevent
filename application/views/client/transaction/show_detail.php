<div class="col-sm-9">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title"><i class="fa fa-list-alt"></i> Votre commande : <a class="pull-right" href="<?= base_url() . 'client/devis?id=' . $detail->id_reservation ?>">Enregistrer en format PDF</a></h4>
			
    </div>
    <div class="panel-body">
      <center>
        <h3 class="page-header">Détails de la commande <br> <small>Numéro de la commande #<?= $detail->id_reservation ?></small></h3>
      </center>
      <div class="col-sm-6">
      ...
      <div class="col-sm-12">
        <table class="table table-bordered table-condensed table-responsive">
          ...
          <tbody>
            <tr>
              <td>1</td>
              <td> Location du Salle de Fête</td>
